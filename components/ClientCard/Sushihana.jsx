...
export default function Sushihana() {
  return (
    <Card>
        <CardActionArea href='https://www.sushihanasan.com/' target='_blank'>
          <CardMedia
            component="img"
            height="fill"
          ...
          <CardContent>
            ...
            entrées and an outstanding selection of premium wine, sake, and Japanese and American beer, Sushihana is the place to go.
            </Typography>
          </CardContent>
        </CardActionArea> 
    </Card>
